...
export const uploadToR2Tool = tool({
    description: "Upload a generated CSV file to Cloudflare R2 storage. " +
    ...
    parameters: z.object({
        ...
        originalPdfKey: z
            .string()
            .describe("The R2 object key of the source PDF (e.g. 'pdfs/statement.pdf')."),
        customOutputKey: z
            .string()
            .optional()
            .describe("Optional custom R2 key for the output. If omitted, one is derived from the PDF key."),
    }),
 ...
 */
function deriveOutputKey(pdfKey) {
